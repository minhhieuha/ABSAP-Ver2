...
public class LoginActivity extends Activity {
	/**
	 * 
	 * Default user name and password for demo.
	 */
	...
	public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
		...
		protected void onPostExecute(final Boolean success) {
			...
			if (success) {
				...
				editor.putString("Authentication_Id",mUsername);
				editor.putString("Authentication_Password",mPassword);
				editor.putString("Authentication_FullName","Abeo");
				editor.commit();
				finish();
