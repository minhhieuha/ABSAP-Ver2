...
public class CashSalesActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		getActionBar().setCustomView(R.layout.cash_sales_custome_actionbar);

		CheckBox mCheckbox = (CheckBox) getActionBar().getCustomView()
				.findViewById(R.id.action_anoni_check);
		mCheckbox
		...
		if (getIntent() != null) {
			...
			mListItem.add(new MasterItem("1", "0105114001", "Gillette Daisy Women 3 Razors(1x240pcs)", "VC02006",2,20000));
			mListItem.add(new MasterItem("2", "0105114002", "Gillette MACH 3  Turbo 1 Up(1x30pcs)", "VC02006",3,30000));
			mListItem.add(new MasterItem("3", "0105114003", "Gillette Sensor Excel Razor for woman (1x144pcs)", "VC02006",4,40000));
			mListItem.add(new MasterItem("4", "0106121003", "Head  Shoulder-70ml(Itchy Scalp Care) (1x48Pcs)", "VC02006",1,10000));
			mListItem.add(new MasterItem("5", "0106121004", "Head  Shoulder-70ml(Men Hair Retain) (1x48Pcs)", "VC02006",7,70000));
			mListItem.add(new MasterItem("6", "0106121005", "Head  Shoulder-70ml(Menthol) (1x48Pcs)", "VC02006",3,30000));
			mListItem.add(new MasterItem("7", "0106121006", "Head  Shoulder-70ml(Slky Smooth)(1x48Pcs)", "VC02006",1,10000));
			mListItem.add(new MasterItem("8", "0107112002", "Olay White Radiance UV Whitening Cream  50g (1X24)", "VC02006",12,120000));
			mListItem.add(new MasterItem("9", "0107112003", "Olay White Radiance Cellucent Cream SPF-24  50g (1X6)", "VC02006",4,40000));
