...
public class CustomerFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View rootView = inflater.inflate(R.layout.fragment_customer, container,
				false);
	...
	public class Task extends AsyncTask<String, Integer, Boolean> {
		...
		protected Boolean doInBackground(String... params) {
			try {
				...
				mDataList.add(new TodayVisit("13", "C00106617",
						"Shwe Dollar",
						"အမှတ်(၄၅၂)၊ဗညားဒလလမ်း၊ဗျိုင်းရေအိုးစဉ်ရပ်ကွက်"));
				mDataList.add(new TodayVisit("14", "C00105197",
						"Saw Store", "​အောင်တေဇလမ်း၊ တာမွေ ၊ ရန်ကုန်၊ မြန်မာ"));
				mDataList
				...
				mDataList.add(new TodayVisit("19", "C00103137",
						"ဒေါ်သန်းသန်း", "အမှတ်-၁၆၁၊ကျိုက္ကဆံလမ်း၊တာမွေ"));
				...
				mDataList.add(new TodayVisit("22", "C00106298",
						"ဇာဇာစတိုး",
				...
				mDataList.add(new TodayVisit("31", "C00103249",
						"​ရွှေဘုန်း", "အမှတ် (၅၃/၅၄) ၊ လယ်ယာရွှေမြေလမ်း"));
				mDataList.add(new TodayVisit("32", "C00104974",
						"စုစုစတိုး", "အမှတ် ( ၅၈၈) ၊ အနန္တဂုဏ်ရည်လမ်း"));
				mDataList
						.add(new TodayVisit("33", "C00104975",
								"ညွန့်ညွန့်စတိုး",
								"အမှတ် (၆၂၂) ၊ အနန္တမေတ္တာညွန့်လမ်း"));
				mDataList.add(new TodayVisit("34", "C00108005",
						"​ရွှေသဇင်", "သမိုင်း ဗဟန်းလမ်း ၊ အသောကကားမှတ်တိုင်"));
				...
				mDataList.add(new TodayVisit("38", "C00102205", "မမေသွင်",
						"အမှတ် ( ၁၈) ၊ အသောကလမ်း"));
				mDataList.add(new TodayVisit("39", "C00104153",
						"ခိုင်စိုးဟန်", "အမှတ် ( ၁၂) ၊ အသောကလမ်း"));
				...
				mDataList.add(new TodayVisit("52", "C00103222",
						"​ဒေါ်အေးရီ",
				...
				mDataList.add(new TodayVisit("54", "C00103225",
						"ဖြိုးမင်းအေး", "အမှတ် (၇၃) ၊ အောင်မင်္ဂလာလမ်း"));
				...
				mDataList
						.add(new TodayVisit("57", "C00107486",
								"Fresh & Fair",
				...
				mDataList.add(new TodayVisit("62", "C00103165",
						"နန်းထိုက်စံ", "အမှတ်(၅၉)(အေ)၊ရေကျော်လမ်း၊"));
